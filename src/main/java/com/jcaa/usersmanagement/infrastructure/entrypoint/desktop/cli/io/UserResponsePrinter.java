...
public final class UserResponsePrinter {
  ...
  private static final String EMPTY_USERS_MESSAGE = "  No users found.";
  ...
  public void printList(final List<UserResponse> users) {
    if (users.isEmpty()) {
      console.println(EMPTY_USERS_MESSAGE);
      return;
    }
  ...
  public void printSummary(final List<UserResponse> users) {
    ...
    users.forEach(this::printSummaryLine);
  }

  private void printSummaryLine(final UserResponse user) {
